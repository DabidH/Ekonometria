...
# 1. Linealidad de los datos. Se supone que la relación entre el predictor (x) y el resultado (y) es lineal.
...
autoplot(lrm, which = 1:6, label.size = 3, data = cars),
         colour = 'Species')


# Grafico 1. Residuos vs. ajuste. Linealidad de los datos 
# Idealmente, el gráfico no mostrará un patrón ajustado (i.e. línea roja debe ser aprox horizontal en cero). 
