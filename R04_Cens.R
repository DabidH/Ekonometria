#####################################################################################################
##################           El modelo de regresión censurado                      ##################
##################           David Hoyos                                           ##################
##################           UPV/EHU, 2021                                         ##################
#####################################################################################################
...
# El modelo de regresión para variables censuradas, está diseñado para estimar las 
...
# Mirando el histograma anterior, podemos ver la censura en los valores de "aptitud", es decir, hay muchos
