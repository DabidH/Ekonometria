...
#####################################################################################################
# El modelo de regresión de Poisson con inflación de ceros
#####################################################################################################
...
# Para estos datos, el cambio esperado en el log(pesca) para un aumento de una unidad en el
# el número de menores -1.5152, manteniendo el resto de variables constantes.

# Un campista (acampada = 1) tiene un cambio esperado en el log(pesca) de 0.88 más alta que un 
# no campista (acampada = 0), manteniendo el resto de variables constantes.

# Las probabilidades de ser un cero excesivo disminuirían en 1.67 por cada persona adicional en el 
# grupo. En otras palabras, cuantas más personas en el grupo menos probabilidades hay de que el 
