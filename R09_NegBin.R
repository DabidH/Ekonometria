...
# El modelo de regresión binomial negativo se usa para modelizar datos de conteo que presentan 
# sobredispersión.
...
# Podemos contrastar la sobredispersion con el paquete pscl
odTest(negbin.model)
...
# Primero, podemos ver los conteos pronosticados para cada valor de prog mientras mantenemos las
# matemáticas en su media. Para hacer esto, creamos un nuevo conjunto de datos con las combinaciones 
# de prog y matemáticas para las que nos gustaría encontrar valores pronosticados, luego usamos el 
