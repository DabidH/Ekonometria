...
# Esperanza de Y según el estimador MCO
...
# La interpretación de parámetros requiere cautela porque los betas estimados no son efectos
# marginales:

# Efectos marginales en el modelo truncado (efecto marginal promedio)
...
# de esta prueba conlleva un aumento de 0.64 unidades en el resultado previsto.
...
# es de 14 puntos, mientras que en el programa general y vocacional son 10 y 9 respectivamente.
